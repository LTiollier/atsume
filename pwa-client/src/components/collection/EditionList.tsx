...
export function EditionList({
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {editionsList.map(({ edition, volumes }) => {
                ...
                return (
          <Card key={edition.id} className="bg-slate-900 border-slate-800 hover:border-primary/50 transition-all flex flex-col">
            ...
            <div className="p-4 pt-0 space-y-2">
              <Button asChild className="w-full bg-slate-800 hover:bg-slate-700 text-primary">
