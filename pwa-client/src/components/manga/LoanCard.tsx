...
export function LoanCard({
    ...
    return (
        <Card
      className={`bg-slate-900/50 border-slate-800 overflow-hidden hover:border-primary/30 transition-all group ${isSelectionMode ? "cursor-pointer" : ""} ${isSelected ? "ring-2 ring-blue-500 border-blue-500/50" : ""}`}
            onClick={() => {
      ...
      <CardHeader className="pb-4">
        <div className="flex justify-between items-start gap-2">
            ...
            className={loan.is_returned ? "bg-slate-800 text-slate-400" : "bg-primary/10 text-primary border-primary/20"}
                    >
