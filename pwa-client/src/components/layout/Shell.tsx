            ...
            <aside className="hidden md:flex flex-col w-72 bg-card border-r border-border h-screen sticky top-0 shrink-0">
                                ...
                                >
                                    ...
                                    {isActive && (
                                        <motion.div 
                                            ...
                                            className="absolute right-0 top-1/2 -translate-y-1/2 w-1.5 h-8 bg-primary rounded-l-full shadow-lg shadow-primary/50"
                                            transition={{ type: "spring", bounce: 0.2, duration: 0.6 }}
                                        />
                                    )}
                                </Link>
                ...
                <div className="p-6 border-t border-border bg-card/50 mt-auto">
                    <motion.div 
                        ...
                        className="flex items-center gap-4 px-4 py-3 mb-4 rounded-xl bg-background border border-border"
                    >
