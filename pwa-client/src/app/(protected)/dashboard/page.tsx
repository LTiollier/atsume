...
export default function DashboardPage() {
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* Welcome Card */}
      <div className="p-8 bg-gradient-to-br from-primary/40 to-indigo-900/40 border border-primary/20 rounded-3xl relative overflow-hidden group">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-bold mb-2">Bienvenue, <span className="text-primary">{user?.name}</span> !</h2>
