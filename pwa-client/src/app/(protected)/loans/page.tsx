      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <div className="relative w-full md:w-80 group">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-slate-500 group-focus-within:text-primary transition-colors" />
            ...
            className="pl-10 h-12 bg-slate-900/50 border-slate-800 rounded-xl focus:ring-primary/20"
                        value={searchQuery}
      ...
      <Tabs defaultValue="active" className="w-full">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
          <TabsList className="bg-slate-900 border-slate-800 p-1 rounded-xl h-12 w-full sm:w-auto">
            <TabsTrigger value="active" className="rounded-lg font-bold data-[state=active]:bg-primary data-[state=active]:text-white h-10 px-6">
              <Clock className="h-4 w-4 mr-2" />
                            En cours ({activeLoans.length})
                        </TabsTrigger>
            <TabsTrigger value="past" className="rounded-lg font-bold data-[state=active]:bg-primary data-[state=active]:text-white h-10 px-6">
