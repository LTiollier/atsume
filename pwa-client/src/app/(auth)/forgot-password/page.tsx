...
import { LucideChevronLeft, LucideMail, LucideLoader2, LucideAlertCircle, LucideCheckCircle2 } from "lucide-react";
          ...
          <CardHeader className="space-y-1 pb-6 text-center">
            <div className="flex justify-center mb-4">
              <div className="p-3 bg-blue-500/10 rounded-2xl ring-1 ring-blue-500/20">
                <LucideMail className="h-8 w-8 text-blue-400" />
                            </div>
                        </div>
            <CardTitle className="text-3xl font-bold tracking-tight text-white">Mot de passe oublié</CardTitle>
            <CardDescription className="text-slate-400">
              ...
              <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl flex flex-col items-center text-center gap-3 animate-in zoom-in-95 duration-300">
                ...
                <div className="space-y-1">
                  <h3 className="font-bold text-emerald-400 text-lg">Email envoyé !</h3>
                  <p className="text-slate-400 text-sm leading-relaxed">
                                        Consultez votre boîte de réception. Si l&apos;email n&apos;apparaît pas, vérifiez vos spams.
                                    </p>
                                </div>
                <Button asChild variant="outline" className="mt-4 border-slate-800 text-slate-300 hover:bg-slate-800">
                  ...
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <FormItem className="space-y-2">
                          ...
                          <FormMessage className="text-pink-400" />
                                        ...
                                        <Button
                                            type="submit"
                      className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold h-11 transition-all duration-200 active:scale-[0.98]"
                                            disabled={isLoading}
                                        >
                                            {isLoading ? (
                                                <>
